...
## Project Structure
    ...
    ├── esc_ordering_booth_41674  # Django project configurations
...
1. Clone this repo and `cd esc_ordering_booth_41674`
...
2. Clone this repo and `cd esc_ordering_booth_41674`
