"""
Django settings for esc_ordering_booth_41674 project.
...
ROOT_URLCONF = 'esc_ordering_booth_41674.urls'
...
WSGI_APPLICATION = 'esc_ordering_booth_41674.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "esc_ordering_booth_41674 API",
    "DESCRIPTION": "API documentation for esc_ordering_booth_41674 App",
    "VERSION": "v1",
}
